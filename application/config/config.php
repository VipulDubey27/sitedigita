...
//header("Content-Security-Policy: default-src 'none'; script-src 'self' https://lalitkala-cms.companydemo.in/js/jquery.validate.js 'unsafe-eval' 'unsafe-inline'; connect-src 'self'; img-src 'self'; style-src 'self';"); 
header("Expect-CT: max-age=7776000, enforce");
header("Permissions-Policy: fullscreen=(self), geolocation=*, camera=(), microphone=()");
header('X-XSS-Protection: 1; mode=block'); 
