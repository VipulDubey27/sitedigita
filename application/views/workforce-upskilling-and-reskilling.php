    ...
    <!-- main area -->
    <section class="mainAreaSection innerPagesArea">
      <!-- What We Do Start -->
      <div class="ServiceTop container mt-150">
        <div class="row">
          <div class="serHead col-lg-9 wow fadeInLeft"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Workforce Upskilling and Reskilling</h1>
            <p>As digital technologies reshape the business landscape, employees need to develop new skills to stay relevant and contribute to the organization's digital transformation efforts. This involves ongoing training, development, and support to help employees adapt to new roles and responsibilities.
            </p>
          </div>
        </div>
      </div>
      ...
      <!-- WEBSITES Area start-->
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Our Approach</h1>
            <p>
              Our approach to upskilling and reskilling is designed to be flexible and scalable, tailored to meet the unique needs of each organization. We use a combination of online and in-person training, hands-on projects, and real-world simulations to help employees learn new skills and apply them in their work.
            </p>
          
          </div>
          <div class="col-md-6 col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/workforce/01.svg"> </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            ...
            <p>We provide in-depth training on technical skills such as programming, data analytics, cloud computing, and cybersecurity.</p>
 <p>Leadership development: We help leaders and managers develop the skills they need to lead their teams in the digital age, including communication, decision-making, and strategic planning.
            </p>
            
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
           <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/workforce/02.svg"> </div>
          </div>
        </div>
      </div>
      <!-- MOBILE APPLICATIONS End -->

      <!-- SEO & DIGITAL MARKETING Start -->
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Soft skills Training</h1>
            <p>We offer courses that cover essential soft skills such as communication, collaboration, and critical thinking.
            </p>
           
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/workforce/03.svg"> </div>
          </div>
        </div>
      </div>
      <!-- .SEO & DIGITAL MARKETING Ends -->

      <!--BRANDING & IDENTITY Start-->
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Customized Training</h1>
            <p>We work with each client to create customized training programs that meet their specific needs and goals.
            </p>
         
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
             <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/workforce/04.svg"> </div>
          </div>
        </div>
      </div>
      <!--BRANDING & IDENTITY Ends-->

      <!-- CONSULTANCY & SUPPORT Start-->
      <div class="ConsultancySec ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Benefits</h1>
            <p>Improved productivity and efficiency: Employees who are upskilled and reskilled are better equipped to handle digital challenges, leading to increased productivity and efficiency.
            </p>
          
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/workforce/05.svg"> </div>
          </div>
        </div>
      </div>
      <!-- CONSULTANCY & SUPPORT End-->
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Enhanced competitiveness</h1>
            <p>By upskilling and reskilling their workforce, companies can stay ahead of the curve and remain competitive in the digital age.
Increased employee retention: Investing in employee development can improve job satisfaction and increase employee loyalty.
            </p>
         
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
              <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/workforce/06.svg"> </div>
          </div>
        </div>
      </div>
      <!--BRANDING & IDENTITY Ends-->
      ...
      <div class="ConsultancySec ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Conclusion</h1>
            <p>At ADG Online Solutions, we believe that workforce upskilling and reskilling is the key to achieving digital transformation success. Our comprehensive training solutions are designed to empower employees with the skills and knowledge they need to succeed in today's digital landscape.
            </p>
          
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/workforce/07.svg"> </div>
          </div>
        </div>
      </div>
      <!-- CONSULTANCY & SUPPORT End-->
      ...
      <div class="banner">
        <a href="<?php echo base_url('index.php/home/contactus'); ?>" class="butn butn__new"><span>Contact Us</span></a>
      </div>
      </section>
      <!-- we are ready end -->