    ...
    <section class="mainAreaSection innerPagesArea">
      ...
      <div class="ServiceTop container mt-150">
        <div class="row">
          <div class="serHead col-lg-9 wow fadeInLeft"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Innovation</h1>
            <p>Digital transformation encourages businesses to explore new ideas, products, and business models to stay competitive in a rapidly evolving market.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Our Approach to Innovation</h1>
            <p>
             At ADG, we take a collaborative approach to innovation, working closely with our clients to identify their unique business challenges and co-create solutions that leverage the latest emerging technologies. Our team of experts stays up-to-date with the latest industry trends, investing in research and development to create innovative solutions that drive business outcomes.
            </p>
          
          </div>
          <div class="col-md-6 col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/innovation/01.svg"> </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            ...
            <p>Our innovation initiatives span a range of areas, including artificial intelligence, cloud computing, data analytics, and cybersecurity. We believe that each of these areas is critical to helping businesses transform and stay ahead of the curve. 
            </p>
            <p>Whether it's leveraging AI to automate processes and drive efficiencies, utilizing cloud computing to improve agility and scalability, or harnessing the power of data analytics to gain insights and drive strategic decision-making, we have the expertise to help our clients succeed.</p>
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
             <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/innovation/02.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Innovation Success Stories</h1>
            <p>At ADG, we've had the privilege of working with a range of clients across various industries to drive innovation and digital transformation. Some examples of successful innovation projects include
            </p>
           
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
           <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/innovation/03.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Future of Innovation</h1>
            <p>Looking ahead, we're excited about the potential of emerging technologies such as blockchain, edge computing, and quantum computing. We're investing in these areas to stay ahead of the curve and ensure that we can continue to provide our clients with innovative solutions that drive business outcomes.
            </p>
         
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
              <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/innovation/04.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ConsultancySec ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Partnering for Innovation</h1>
            <p>We believe that collaboration is key to successful innovation. If you're interested in partnering with ADG Online Solutions on an innovation project, please don't hesitate to get in touch with our team. We'll work closely with you to identify your unique business challenges and create a customized solution that meets your needs.
            </p>
          
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/innovation/05.svg"> </div>
          </div>
        </div>
      </div>
