    ...
    <section class="mainAreaSection innerPagesArea">
      ...
      <div class="ServiceTop container mt-150">
        <div class="row">
          <div class="serHead col-lg-9 wow fadeInLeft"  data-wow-delay="000ms" data-wow-duration="1500ms">
            ...
            <p>Leveraging data is a crucial aspect of digital transformation. Businesses need to collect, analyze, and use data to make more informed decisions, optimize operations, and identify new opportunities.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Our Approach to Data-Driven Decision-Making</h1>
            <p>
              Our team of data analysts and experts can help businesses collect, analyze, and make sense of the data they collect. We develop a customized data strategy that includes identifying KPIs, collecting data, analyzing it, visualizing it, and providing recommendations.
            </p>
          
          </div>
          <div class="col-md-6 col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
           <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/data_driven/01.svg"> </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>How We Help Businesses Make Informed Decisions with Data</h1>
            <p>We help businesses collect and analyze their data, create visualizations, and provide recommendations based on the analysis. Our services include data collection and integration, data analysis and modeling, data visualization, and data-driven recommendations.
            </p>
            
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/data_driven/02.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Benefits of Adopting a Data-Driven Approach</h1>
            <p>Adopting a data-driven approach can provide numerous benefits to businesses, including making informed decisions, identifying new opportunities, improving customer experience, reducing costs, and staying ahead of the competition.

            </p>
           
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
          <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/data_driven/03.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Case Studies</h1>
            <p>We showcase case studies of businesses that have benefited from our data-driven approach. For each case study, we provide a brief overview of the client's business, the challenges they faced, and how we helped them leverage data to overcome those challenges.
            </p>
         
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
             <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/data_driven/04.svg"> </div>
          </div>
        </div>
      </div>
