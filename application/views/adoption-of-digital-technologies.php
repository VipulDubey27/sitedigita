    ...
    <section class="mainAreaSection">
      ...
      <div class="ServiceTop container mt-150">
        <div class="row">
          <div class="serHead col-lg-9 wow fadeInLeft"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Adoption of Digital Technologies</h1>
            <p>This involves implementing modern technologies such as cloud computing, artificial intelligence, big data analytics, the Internet of Things (IoT), and automation to enhance business operations and customer interactions.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            ...
            <p>
              At ADG, we specialize in cloud computing solutions that can help businesses streamline their operations, store their data securely, and save costs. We work with clients to assess their needs and find the best cloud solution for their business.
            </p>
          
          </div>
          <div class="col-md-6 col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/adoption/01.svg"> </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            ...
            <p>We are at the forefront of AI technology, helping businesses leverage it for personalized marketing, chatbots, and improved customer service. We work with clients to develop custom AI solutions that can improve accuracy and efficiency in decision-making.
            </p>
            
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/adoption/02.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            ...
            <p>Our team of experts helps businesses make sense of big data, providing insights into customer behavior and market trends. We work with clients to develop custom data analytics solutions that can optimize their operations and drive growth.
            </p>
           
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
           <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/adoption/03.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            ...
            <p>We specialize in IoT solutions that can help businesses automate processes, improve efficiency, and reduce costs. We work with clients to address the security challenges of IoT and implement solutions that can protect their data.
            </p>
         
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
              <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/adoption/04.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ConsultancySec ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Automation</h1>
            <p>Our team is experienced in developing automation solutions that can streamline repetitive tasks and reduce the risk of human error. We work with clients in various industries, including finance, healthcare, and retail, to implement automation solutions that can improve their operations.
            </p>
          
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
           <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/adoption/05.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <!-- CONSULTANCY & SUPPORT Start-->
      <div class="ConsultancySec ServiceTop container mt-100 text-center">
        <div class="row">
          <div class="serHead col-md-12 wow pulse plr-100"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <p>At ADG Online Solutions, we are dedicated to helping businesses stay ahead of the curve by embracing digital transformation and investing in modern technologies. We work with clients to develop a roadmap for digital transformation success and provide ongoing support to ensure their success.
            </p>
      ...
      <div class="banner">
        <a href="<?php echo base_url('home/contactus'); ?>" class="butn butn__new"><span>Contact Us</span></a>
      </div>
      </section>
      <!-- we are ready end -->
