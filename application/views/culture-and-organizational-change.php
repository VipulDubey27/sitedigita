    ...
    <section class="mainAreaSection innerPagesArea">
      ...
      <div class="ServiceTop container mt-150">
        <div class="row">
          <div class="serHead col-lg-9 wow fadeInLeft"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Culture and organizational change</h1>
            <p>Successful digital transformation involves fostering a culture that embraces innovation, experimentation, and continuous learning. It requires strong leadership to drive the change, as well as the commitment and collaboration of all employees.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Creating a culture of innovation</h1>
            <p>
          ...
          <div class="col-md-6 col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/culture/01.svg"> </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>The role of leadership in driving change</h1>
            <p>Leadership plays a critical role in driving digital transformation success, and we help clients develop leaders who set the tone and lead by example.
            </p>
            
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
             <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/culture/02.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Embracing continuous learning</h1>
            <p>Continuous learning is essential for digital transformation, and we help clients develop a growth mindset and promote ongoing learning and development.
            </p>
           
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/culture/03.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ServiceTop container mt-100">
        <div class="row flex-row-reverse">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            ...
            <p>Collaboration and communication are essential for digital transformation, and we help clients break down silos and build cross-functional teams.
            </p>
         
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
           <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/culture/04.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ConsultancySec ServiceTop container mt-100">
        <div class="row">
          <div class="serHead col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <h1>Overcoming resistance to change</h1>
            <p>Resistance to change is natural, but we help clients address fears and skepticism with empathy and support.
            </p>
          
          </div>
          <div class="col-md-6 wow pulse"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <div class="IconAreaPanel"><img src="<?= base_url(); ?>assets/images/culture/05.svg"> </div>
          </div>
        </div>
      </div>
      ...
      <div class="ConsultancySec ServiceTop container mt-100 text-center">
        <div class="row">
          <div class="serHead col-md-12 wow pulse plr-100"  data-wow-delay="000ms" data-wow-duration="1500ms">
            <p>Helping clients build a culture for digital transformation success</p>
<p>At ADG Online Solution we are dedicated to helping clients build a culture that supports digital transformation success through innovation, leadership, learning, collaboration, and change management.
            </p>
